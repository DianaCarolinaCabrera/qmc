...
class QMKDClassifierSGD_W2VL2(tf.keras.Model):
    """
    A Quantum Measurement Kernel Density Classifier model trainable using
    gradient descent.
    ...
    """
    def __init__(self, input_dim, dim_x, num_classes, num_eig=0, gamma=1, random_state=None):
        super(QMKDClassifierSGD_W2VL2, self).__init__()
        self.fm_x = layers.W2VL2(
            input_dim=input_dim)
        self.dim_x = dim_x
        self.num_classes = num_classes
        self.qmd = []
...
class QMKDClassifierSGD_BOWL1(tf.keras.Model):
    """
    A Quantum Measurement Kernel Density Classifier model trainable using
    gradient descent.
    ...
    """
    def __init__(self, input_dim, dim_x, num_classes, num_eig=0, gamma=1, random_state=None):
        super(QMKDClassifierSGD_BOWL1, self).__init__()
        self.fm_x = layers.BOWL1(
            input_dim=input_dim)
        self.dim_x = dim_x
        self.num_classes = num_classes
        self.qmd = []
...
class QMKDClassifierSGD_TFIDFL1(tf.keras.Model):
    """
    A Quantum Measurement Kernel Density Classifier model trainable using
    gradient descent.
    ...
    """
    def __init__(self, input_dim, dim_x, num_classes, num_eig=0, gamma=1, random_state=None):
        super(QMKDClassifierSGD_TFIDFL1, self).__init__()
        self.fm_x = layers.TFIDFL1(
            input_dim=input_dim)
        self.dim_x = dim_x
        self.num_classes = num_classes
        self.qmd = []
...
class QMKDClassifierSGD_TFIDFL1L2(tf.keras.Model):
    """
    A Quantum Measurement Kernel Density Classifier model trainable using
    gradient descent.
    ...
    """
    def __init__(self, input_dim, dim_x, num_classes, num_eig=0, gamma=1, random_state=None):
        super(QMKDClassifierSGD_TFIDFL1L2, self).__init__()
        self.fm_x = layers.TFIDFL1L2(
            input_dim=input_dim)
        self.dim_x = dim_x
        self.num_classes = num_classes
        self.qmd = []
