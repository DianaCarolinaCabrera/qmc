...
class W2VL2(tf.keras.layers.Layer):
    """W2VL2 layer for replace QFeatureMapRFF function.
    Represents the x_vectors after normalization L2 and rebalanced:
    ...
    """
    @typechecked
    def __init__(self, input_dim: int = 100, **kwargs):
        super().__init__(**kwargs)
        if input_dim == 0:
            raise NotImplementedError("Dimension of input "
                                      "{}.".format(input_dim))
